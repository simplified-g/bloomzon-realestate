...
if(isset($_GET["search"]) && $_GET["search"] != ""){
    ...
    $query = mysqli_query($con, "SELECT * FROM property_info WHERE title LIKE '%$search%' OR description LIKE '%$search%' OR address LIKE '%$search%' OR region LIKE '%$search%' OR state LIKE '%$search%';");
