                ...
                <div class="row">
                    ...
                    <div class="properties">
                        <div class="row">
                            <?php
									if(isset($_GET['city'])){
										$location = $emscms->wordify($_GET['city'],1);
										$emscms->post_properties_by_city($location);
									}else if(isset($_GET['status'])){
										$status = $emscms->wordify($_GET['status'],1);
										$emscms->post_properties_by_status($status);
									}else if(isset($_GET['type'])){
										$type = $emscms->wordify($_GET['type'],1);
										$emscms->post_properties_by_type($type);
									}else if(isset($_GET['select-lga']) && isset($_GET['select-type']) && isset($_GET['select-status'])){
										$emscms->post_search_result();
									}else{
										$emscms->goto_notify("index.php");
									}
								?>
                        </div>
                    </div>
