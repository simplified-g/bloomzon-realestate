<!-- ============================================================== -->
                ...
                <div class="right-sidebar">
                    <div class="slimscrollright">
                        <div class="rpanel-title"> Change Theme <span><i class="ti-close right-side-toggle"></i></span> </div>
            ...
            <!-- ============================================================== -->
            <footer class="footer">
                © <?php echo date("Y");?> Emiserve Admin
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
	...
	<script src="../resources/plugins/summernote/dist/summernote.min.js" type="text/javascript"></script>
