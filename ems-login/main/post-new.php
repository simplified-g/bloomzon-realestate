        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Add New Post</h3>
                </div>
               ...
               <div class='row'>
                    ...
                    <?php endif;?>
  					<?php if(in_array("slug",$usedfields)):;?>
                                  <div class='form-group'>
                                        <?php $emscms->base();echo"/$catslug" ?>/<input type='text' name='slug' id='slug' class='form-control-line' placeholder='<?php echo showlabel('slug','Slug');?>' style='border:1px solid silver'  <?php echo in_array("slug",$reqfields)?"required":"";?>> 
									</div>
                    <?php endif;?>
...
var catid =  $(this).val();
	if(confirmThisAction("This Page Will Be Reloaded,\nPlease Save Your Work First")){
		window.location = "post-new?catid="+catid;
	}
});
