...
if(isset($_GET['delid'])){
	...
	$username=$emscms->get_this_data("usuere","users","id",$delid);
		...
		$reply = $status < 0 ?$emscms->just_notify("User Succefully Deleted"):$emscms->just_notify("Error! Could Not Delete User, Please Retry Later.",2);
		}
	}
	}
?>
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Manage Users <a href='user-new.php' class='btn btn-primary'><i class='mdi mdi-plus'></i> Add New</a></h3>
                </div>
                    ...
                    <div class="col-12">
						...
						<?php echo $reply;?>
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Search, Sort, Edit and Delete Users</h6>
