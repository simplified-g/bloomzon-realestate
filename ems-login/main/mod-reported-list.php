<?php require_once("../commonincs/header_admin.inc.php");
	...
	if(isset($_GET['delid'])){
		...
		if($delid > 0){
			...
			$status = $emscms->delete_this_data("property_reports","id",$delid);
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">View Reported Properties</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Reported Properties</li>
                    </ol>
                </div>
                <div>
			...
			<div class="row">
                    <div class="col-12">
						...
						<?php echo $reply;?>
                            <div class="card-body">
                                <h4 class="card-title">Reported Properties</h4>
								
                                <h6 class="card-subtitle">Search, Sort, Edit and Delete Reports</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php echo $emscms->mod_list_reports(); ?>
										</tbody>
                                    </table>
                                </div>
                            </div>
