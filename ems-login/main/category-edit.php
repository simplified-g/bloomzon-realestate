...
$reply = $emscms->update_category_widget(1);
}
if($catid>=0){
	$emscms->select_category($catid, $title, $slug, $usedfields, $requiredfields, $fieldlabels,1);
}else{
	$emscms->goto_notify("category-list.php");
}
?>
